# KITCHEN NARROW PASSAGE________________________________________________
...
roslaunch cob_default_env_config upload_object_locations_e0nav3.launch
...
rosrun cob_bringup_sim spawn_object.py table_ikea_bjursta_narrow_passage
...
rosrun cob_bringup_sim spawn_object.py crate_small3
